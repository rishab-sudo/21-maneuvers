...
const workItems = [
  {
    id: 1,
    image: require("../assets/services/pm-black2.png"),
    hoverImage: require("../assets/services/pm-color2.png"),
    text: "Performance Marketing",
    link: "/performance-service",
  },
  {
    id: 2,
       image: require("../assets/services/smm-black.png"),
    hoverImage: require("../assets/services/smm-color.png"),
    ...
    link: "/Smm-service",
      ...
      {
    id: 3,
    image: require("../assets/services/graphic-black.png"),
    hoverImage: require("../assets/services/graphic-color.png"),
